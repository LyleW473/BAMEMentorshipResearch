...
if __name__ == "__main__":
    for problem_number in range(1, len(os.listdir("problems/problems")) + 1):
        ...
        total_per_length_A, total_sqs_per_length_A, grades_per_length_A, correct_per_length_A, num_incorrect_responses_A, avg_grade_A = info_A
        draw_bar_chart(
        ...
        total_per_length_B, total_sqs_per_length_B, grades_per_length_B, correct_per_length_B, num_incorrect_responses_B, avg_grade_B = info_B
        draw_bar_chart(
